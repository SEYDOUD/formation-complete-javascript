...
// renameFile('file1.txt' , 'file.txt') rename the file
// deleteFile('file4.txt') delete a file
// readFile('file1.txt') read a file
// createFile('file4.txt','Hello World 4') create a file